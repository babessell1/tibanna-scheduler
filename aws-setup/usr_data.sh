...
wget --directory-prefix=ref/ http://hgdownload.soe.ucsc.edu/goldenPath/hg38/bigZips/hg38.fa.gz

# download big-sv snakemake pipeline
git clone https://github.com/babessell1/big-sv.git
...
aws s3 cp s3://niagads-bucket/samples2call.txt ./checkout.txt
...
mkdir -p crams
aws s3 cp --request-payer requester s3://wanglab-dss-share/distribution/adsp/cram/snd10011/A-ROS-RS000011-BL-RUS-a0608_vcpa1.1.cram crams/A-ROS-RS000011-BL-RUS-a0608_vcpa1.1.cram